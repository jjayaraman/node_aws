...
var elastisearchUtils_1 = require("./../service/elastisearchUtils");
var search = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var ES_DOMAIN, ES_INDEX, client, result, es, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ES_DOMAIN = process.env.ES_DOMAIN || '';
                ES_INDEX = process.env.ES_INDEX;
                console.log("domain : ".concat(ES_DOMAIN));
                if (!ES_DOMAIN) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                es = new elastisearchUtils_1.ElasticsearchUtils(client);
                return [4 /*yield*/, es.search(ES_INDEX)];
            case 2:
                result = _a.sent();
                console.debug("Search results: ".concat(result));
                return [2 /*return*/, {
                        statusCode: 200,
            ...
            case 3:
                ...
                return [2 /*return*/, {
                        statusCode: 401,
                        body: "And error occured: ".concat(JSON.stringify(error_1.message)),
                    }];
